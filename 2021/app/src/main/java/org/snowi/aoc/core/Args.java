...
public final class Args {
    ...
    /**
     * Checks if the length of a given <code>String</code> is not greater than a
     * maximum length. Null values are allowed.
     *
     * @param value     value to be checked
     * @param maxLength maximum length for the given value
     * @param message   error message
     * @param args      additional arguments to be sent with the exception
     * @throws IllegalArgumentException if the length of the given
     *                                  <code>value</code> is greater than
     *                                  <code>maxLength</code>
     */
    ...
    /**
     * Checks if the length of a given <code>String</code> is not less than a
     * minimum length. Null values are allowed.
     *
     * @param value     value to be checked
    ...
    /**
     * Checks if a given <code>String</code> matches a regular expression. Null
     * values are allowed.
     *
     * @param value   value to be checked
     ...
     * @param message error message
     * @param args    additional arguments to be sent with the exception
     * @throws IllegalArgumentException if the given <code>value</code> does not
